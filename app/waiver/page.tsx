        ...
        {alreadySigned ? (
          ...
          <>
            ...
            <div style={{ background: 'white', borderRadius: '16px', padding: '28px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: '1.5px solid #eef0f5', marginBottom: '16px', maxHeight: '480px', overflowY: 'auto', lineHeight: '1.8', color: '#555', fontSize: '14px' }}>
              ...
              <h4 style={{ color: '#003087', fontWeight: '800', fontSize: '13px' }}>1. SERVICES</h4>
              ...
              <h4 style={{ color: '#003087', fontWeight: '800', fontSize: '13px' }}>2. ASSUMPTION OF RISK</h4>
              ...
              <h4 style={{ color: '#003087', fontWeight: '800', fontSize: '13px' }}>3. HEALTH AND VACCINATION REQUIREMENTS</h4>
              ...
              <h4 style={{ color: '#003087', fontWeight: '800', fontSize: '13px' }}>4. RELEASE OF LIABILITY</h4>
              ...
              <h4 style={{ color: '#003087', fontWeight: '800', fontSize: '13px' }}>5. CANCELLATION POLICY</h4>
              ...
              <h4 style={{ color: '#003087', fontWeight: '800', fontSize: '13px' }}>6. PAYMENT</h4>
              ...
              <h4 style={{ color: '#003087', fontWeight: '800', fontSize: '13px' }}>7. PHOTO AND MEDIA RELEASE</h4>
              ...
              <h4 style={{ color: '#003087', fontWeight: '800', fontSize: '13px' }}>8. PROPERTY ACCESS</h4>
              ...
              <h4 style={{ color: '#003087', fontWeight: '800', fontSize: '13px' }}>9. GOVERNING LAW</h4>
              ...
              <h4 style={{ color: '#003087', fontWeight: '800', fontSize: '13px' }}>10. ENTIRE AGREEMENT</h4>
              ...
              <form onSubmit={handleSubmit}>
                <div style={{ marginBottom: '18px' }}>
                  <label style={labelStyle}>
                    Type your full name to sign: <span style={{ color: '#FF6B35', fontWeight: '800' }}>"{ownerName}"</span>
                  </label>
                ...
                <div style={{ marginBottom: '22px', display: 'flex', alignItems: 'flex-start', gap: '12px', background: '#f8f9ff', border: '1.5px solid #e5e8f0', borderRadius: '12px', padding: '16px' }}>
                  <input type="checkbox" id="agree" checked={agreed} onChange={e => setAgreed(e.target.checked)}
                    style={{ marginTop: '2px', width: '18px', height: '18px', cursor: 'pointer', flexShrink: 0, accentColor: '#003087' }} />
