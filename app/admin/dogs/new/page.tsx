            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              ...
              <div>
                ...
                <select value={city} onChange={e => setCity(e.target.value)} style={{ ...inputStyle, background: 'white' }}>
                  ...
                  {['Carmel', 'Zionsville', 'Whitestown', 'Fishers', 'Geist', 'McCordsville', 'Fortville', 'Westfield', 'Noblesville', 'Pendleton', 'Indianapolis', 'Sheridan', 'Greenwood'].map(c => <option key={c} value={c}>{c}</option>)}
                </select>
              </div>
            </div>
