...
export async function POST(request: Request) {
  ...
  const achievementSection = achievementsUnlocked && achievementsUnlocked.length > 0
    ? `<div style="background:#fff3e0;border-radius:8px;padding:16px;margin:16px 0;">
        <p style="margin:0 0 8px 0;font-weight:bold;color:#FF6B35;">🏆 New Achievement${achievementsUnlocked.length > 1 ? 's' : ''} Unlocked!</p>
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
          ...
          <div style="background:white;padding:24px;border:1px solid #eee;">
            <h2 style="color:#003087;margin:0 0 4px 0;">${dogName} crushed it today! 💪</h2>
            ...
            <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:24px;">
              <div style="background:#f5f5f5;padding:16px;border-radius:8px;text-align:center;">
                ...
                <div style="font-size:20px;font-weight:bold;color:#003087;">${duration} min</div>
                <div style="font-size:12px;color:#666;">Duration</div>
              </div>
              <div style="background:#f5f5f5;padding:16px;border-radius:8px;text-align:center;">
                <div style="font-size:24px;">📍</div>
                <div style="font-size:20px;font-weight:bold;color:#003087;">${miles || '—'}</div>
                <div style="font-size:12px;color:#666;">Miles</div>
              </div>
              <div style="background:#f5f5f5;padding:16px;border-radius:8px;text-align:center;">
                <div style="font-size:24px;">🔥</div>
                <div style="font-size:20px;font-weight:bold;color:#003087;">${calories || '—'}</div>
            ...
            ${notes ? `<div style="background:#f9f9f9;border-left:4px solid #FF6B35;padding:12px 16px;border-radius:0 8px 8px 0;margin-bottom:24px;">
