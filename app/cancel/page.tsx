  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      ...
      <div style={{ padding: '32px', maxWidth: '600px', margin: '0 auto' }}>
        <h2 style={{ color: '#003087', marginBottom: '24px' }}>Cancel Session</h2>
        ...
        {success ? (
          <div style={{ backgroundColor: 'white', padding: '32px', borderRadius: '12px', textAlign: 'center', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
            ...
            {hasFee && !dogIsSick ? (
              <div style={{ backgroundColor: '#fff3cd', border: '1px solid #ffc107', padding: '16px', borderRadius: '8px', marginBottom: '16px' }}>
                <p style={{ margin: 0, color: '#856404', fontWeight: 'bold' }}>⚠️ Cancellation Fee Applied</p>
          ...
          <>
            {/* Booking summary */}
            <div style={{ backgroundColor: '#003087', color: 'white', padding: '20px', borderRadius: '12px', marginBottom: '24px' }}>
            ...
            {/* Fee warning */}
            {hasFee && (
              <div style={{ backgroundColor: '#fff3cd', border: '1px solid #ffc107', padding: '16px', borderRadius: '8px', marginBottom: '24px' }}>
                <p style={{ margin: 0, color: '#856404', fontWeight: 'bold' }}>⚠️ Late Cancellation Warning</p>
                <p style={{ margin: '8px 0 0 0', color: '#856404', fontSize: '14px' }}>This session is less than 48 hours away. A cancellation fee will apply unless your dog is sick.</p>
              </div>
            )}
            ...
            <div style={{ backgroundColor: 'white', padding: '32px', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
              <form onSubmit={handleCancel}>
                ...
                {reason === 'dog_is_sick' && (
                  <div style={{ backgroundColor: '#d4edda', padding: '12px', borderRadius: '8px', marginBottom: '16px' }}>
                ...
                <button type="submit" disabled={cancelling}
                  onClick={() => setDogIsSick(reason === 'dog_is_sick')}
                  style={{ width: '100%', padding: '12px', backgroundColor: '#dc3545', color: 'white', border: 'none', borderRadius: '6px', fontSize: '16px', fontWeight: 'bold', cursor: 'pointer' }}>
